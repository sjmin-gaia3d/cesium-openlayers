...
export const activateDraw = (drawType, viewer, dataSource) => {
...
export const activateSelect = (viewer) => {
...
export const activateModify = (viewer, dataSource) => {
...
export const activateSelectRemove = (viewer, dataSource) => {
